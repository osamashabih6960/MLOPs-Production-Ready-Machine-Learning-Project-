...
from src.pipline.prediction_pipeline import srcData, srcClassifier
...
async def index(request: Request):
    ...
    return templates.TemplateResponse(
            "src.html",{"request": request, "context": "Rendering"})
...
async def predictRouteClient(request: Request):
    try:
        ...
        src_df = src_data.get_src_input_data_frame()

        model_predictor = srcClassifier()

        value = model_predictor.predict(dataframe=src_df)[0]
